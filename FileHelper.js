 ...
 */
         ...
         storage: multer.diskStorage({
             ...
             destination: (req, file, callback) => {
                 ...
                 */
                 ...
                 // 업로드 될 폴더를 생성함
             const upload_dir = process.env.UPLOAD_DIR+"/"+dirName.upload_dir;
             const thumb_dir = process.env.THUMB_DIR+"/"+dirName.thumb_dir;
                 ...
                 file.upload_dir = upload_dir.replace(/\\/gi, '/');
                 file.thumb_dir = thumb_dir.replace(/\\/gi, '/');
 ...
 const createThumbnail = (file,dirName) => {
     ...
     size.map( async (v, i) => {
         ...
         const thumb_options = {
             ...
             destination: process.env.THUMB_DIR+"/"+dirName.thumb_dir, // 썸네일이 생성될 경로
